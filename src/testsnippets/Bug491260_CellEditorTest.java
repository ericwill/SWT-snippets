 ...
 *
 */
public class Bug491260_CellEditorTest {
    ...
    public Bug491260_CellEditorTest(Shell shell) {
        ...
        TextCellEditor cellEditor = new TextCellEditor(v.getTable());
//      cellEditor.setDialogMessage("Enter email address");
    ...
    public static void main(String[] args) {
        ...
        new Bug491260_CellEditorTest(shell);
        shell.open();
