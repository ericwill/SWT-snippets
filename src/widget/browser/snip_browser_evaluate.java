...
//				widget.browser.evaluate(script);
				
//				widget.browser.execute(script);
//				String value = (String)widget.browser.evaluate("return document.getElementById('myid').childNodes[0].nodeValue;");
//				String value = (String)widget.browser.evaluate("return 'hello'");
//				Double value = (Double) widget.browser.evaluate("return 123");
//				Double value = (Double) widget.browser.evaluate("return 123.456");
//				Boolean value = (Boolean) widget.browser.evaluate("return false");
//				Boolean value = (Boolean) widget.browser.evaluate("return true");
//				Boolean value = (Boolean) widget.browser.evaluate("return null");
//				System.out.println("Returned: " + value.toString());
//				
//				Object [] value = (Object[]) widget.browser.evaluate("return new Array(\"Saab\", \"Volvo\", \"BMW\")");
//				System.out.println("Node value: "+ value[0] + " " + value[1]);

//				Object [] value = (Object[]) widget.browser.evaluate("return new Array(1, 2, new Array(3.1, 3.2)");
//				System.out.println("1: " + value[0] + " 2:" + value[1] + " 3:" + value[2]);
//
//				widget.browser.evaluate("throw 'meh has occured'");
				browser.evaluate("return myUndefinedFunction()");
//				try {
//				Boolean value = (Boolean) widget.browser.evaluate("return new Date()");
